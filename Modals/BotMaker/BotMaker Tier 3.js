...
module.exports = {
    ...
    run: async (client, interaction, args, config) => {
        try {
            ...
            if (ID === 1102027278646513724 || ID === "1138915711469752340") return interaction.reply(`لا يمكنك شراء اشتراك للسيرفر الاساسي`)
            ...
            client0.login(token).then(async () => {
                ...
                const buyerembed = new MessageEmbed()
                    ...
                    .setDescription(
                        `*لقد قمت بالاشتراك في General Bot Maker*
                        - مده الاشتراك 30 يوم
                        *WhiteListID :* \`${SUB_ID}\`
                            ...
                            client1.on('ready', () => {
                                ...
                                setInterval(() => {
                                    os.cpuUsage((cpuUsage) => {
                                        ...
                                        client1.user.setActivity(statuses[statusIndex], {
                                            type: 'COMPETING',
                                            url: 'https://www.twitch.tv/GeneralMaker',
                                        });
                                        client1.user.setPresence({
                                            status: "online",
                                        });

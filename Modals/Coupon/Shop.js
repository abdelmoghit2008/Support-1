...
module.exports = {
    ...
    run: async (client, interaction, args, config) => {
        ...
        try {
            if(data){
                let Code = interaction.fields.getTextInputValue("Shop_Redeem")
                ...
                if(da){
                    ...
                    const ShopPrice = db3.get(`ShopP_${interaction.guild.id}`) || db3.get(`ShopP`) || 2;
                    const Shoptotalprice = Math.floor(ShopPrice * (1 - (discount / 100)) * (20 / 19) + 1);

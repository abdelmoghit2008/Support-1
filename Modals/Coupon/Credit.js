...
module.exports = {
    ...
    run: async (client, interaction, args, config) => {
        ...
        try {
            if(data){
                let Code = interaction.fields.getTextInputValue("Credits_Redeem")
                ...
                if(da){
                    ...
                    const CreditPrice = db3.get(`CreditP_${interaction.guild.id}`) || db3.get(`CreditP`) || 2;
                    const Credittotalprice = Math.floor(CreditPrice * (1 - (discount / 100)) * (20 / 19) + 1);

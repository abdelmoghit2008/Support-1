...
module.exports = {
    ...
    run: async (client, interaction, args, config) => {
      ...
      try {
        if(data){
            let Code = interaction.fields.getTextInputValue("Giveaway_Redeem")
            ...
            if(da){
                ...
                const GiveawaysPrice = db3.get(`GiveawaysP_${interaction.guild.id}`) || db3.get(`GiveawaysP`) || 2;
                const Giveawaystotalprice = Math.floor(GiveawaysPrice * (1 - (discount / 100)) * (20 / 19) + 1);

...
const giveawaydb = new Database("/Json-db/Bots/GiveawaysDB.json")
...
module.exports = {
    ...
    async run(client, interaction) {
        try {
            const data = giveawaydb.get(`giveaway_Status_${client.user.id}`) || []
            ...
            giveawaydb.set(`giveaway_Status_${client.user.id}`, {
                Activity:activity,
                Type:type,
                Presence:presence,
            }).then(() => {

...
const suggestiondb = new Database("/Json-db/Bots/SuggestionDB.json")
...
module.exports = {
    ...
    async run(client, interaction) {
        try {
            const data = suggestiondb.get(`suggestion_Status_${client.user.id}`) || []
            ...
            suggestiondb.set(`suggestion_Status_${client.user.id}`, {
                Activity:activity,
                Type:type,
                Presence:presence,
            }).then(() => {
